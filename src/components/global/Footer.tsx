    ...
    <footer className="bg-black">
      <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-0 grid grid-cols-1 gap-6  border-gray-100 pt-16 md:grid-cols-4 lg:grid-cols-6">
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-mediumtext-white-900">Our Services</p>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-mediumtext-white-900">Contact Us</p>
          ...
          <div className="text-center sm:text-left">
            <p className="text-lg font-mediumtext-white-900">Helpful Links</p>
      ...
      <div className="mx-auto mt-8 max-w-md sm:ms-0">
        ...
        <div className="mt-16 border-t border-gray-100 pt-6 sm:flex sm:items-center sm:justify-between">
          <p className="text-center text-smtext-white-500 sm:text-left">
